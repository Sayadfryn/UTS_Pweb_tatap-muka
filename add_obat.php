...
if ($_POST) {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO obat (nama_obat, jenis, dosis, deskripsi) VALUES (?, ?, ?, ?)");
        $stmt->execute([$nama_obat, $jenis, $dosis, $deskripsi]);
    ...
    <header class="navbar text-white p-4 fixed top-0 w-full z-10">
        <div class="container mx-auto px-6 flex justify-between items-center">
            <div class="flex items-center">
                ...
                <h1 class="text-xl font-bold">Peternakan Nusantaran</h1>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 card animate-fade-in max-w-2xl mx-auto">
            ...
            <form method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="jenis" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-600" placeholder="Masukkan jenis obat (e.g., Vitamin)">
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2"><i class="fas fa-syringe mr-2"></i>Dosis</label>
                    <input type="text" name="dosis" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-600" placeholder="Masukkan dosis (e.g., 1ml/kg)">
                </div>
                <div class="mb-6">
                    <label class="block text-gray-700 text-sm font-bold mb-2"><i class="fas fa-info-circle mr-2"></i>Deskripsi</label>
                    <textarea name="deskripsi" rows="3" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-600" placeholder="Masukkan deskripsi obat"></textarea>
                </div>
